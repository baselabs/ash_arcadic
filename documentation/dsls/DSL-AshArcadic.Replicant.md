...
| [`tenant_attribute`](#replicant-tenant_attribute){: #replicant-tenant_attribute } | `atom` |  | Source column carrying the tenant. Resolved per row and passed as `tenant:` to the mirror action. |
